...
public class RockPaperScissors {
	...
	//if value is either 1, 2 or 3, then the turn is valid if not then invalid.
	...
	//if the input is r, p or s, then the corresponding turn is allocated and if not then input is invalid.
	...
	//nesting the if statements for neatness. there are three instances where the play wins and three 
	//where the computer wins. the rest are draws.
	...
	// converting turns to strings as an output.
/* ************************************************************************************
